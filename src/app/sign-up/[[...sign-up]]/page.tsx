  ...
  return (
    <div className="min-h-screen bg-bg-abyss flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-accent-sage/5 rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 left-1/4 w-[500px] h-[500px] bg-bg-forest/20 rounded-full blur-3xl" />
      </div>
      
      <div className="z-10 relative">
        <div className="mb-8 text-center">
          <h1 className="font-heading text-3xl font-black text-accent-mint uppercase tracking-wider mb-2">
            AEGIS Personnel Registration
          </h1>
